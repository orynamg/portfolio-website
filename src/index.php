    ...
    <div class="container">
        ...
        <div class="experience-set">
            <div class="left">
                ...
                <h2>August 2019</h2>
                <h3>I joined the Refinitiv Labs for my work experience during my A-Levels. It was an extremely educative experience to observe engineering, Data Science and User Experience teams collaborating on ongoing projects. I had an opportunity to interview the team leaders of each sector, expanding my understanding of the different components required to run a company. The most thought-provoking department managers I spoke to were managers of HR, the Environmental department and Finance..</h3>
                <h3>
            ...
            <div class="right">
                ...
                <h3>For three months, I worked on a series of reports that visualised information about available guest orders for many hotel branches for a company Iris to assist it in better understanding their data. I plotted a succession of graphs using Matplotlib for data visualisation and used Pandas for data manipulation to analyse the raw data. I have gained a much knowledge from this project and have built great relationships with my co-workers</h3>
            </div>
        </div>
