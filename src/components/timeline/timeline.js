fetch("components/timeline/timeline.html")
	...
	.then(text => defineHorizontalTimeline(text));

function defineHorizontalTimeline(html) {
	class HorizontalTimeline extends HTMLElement {
		constructor() {
			super();
			var shadow = this.attachShadow({mode: 'open'});
			shadow.innerHTML = html;
			componentReady(shadow);
		}
	}
	customElements.define('horizontal-timeline', HorizontalTimeline);
}

function componentReady(root) {
	const timelines = root.querySelectorAll('.cd-horizontal-timeline')
